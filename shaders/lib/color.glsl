...
#define color_LMS_TO_XYZ mat3( \
    vec3(1.91019683, 0.37095009, 0.00000000), \
    vec3(-1.11212389, 0.62905426, -0.00000000), \
    vec3(0.20190796, -0.00000806, 1.00000000) \
)
#define color_XYZ_TO_LMS mat3( \
    vec3(0.38971000, -0.22981000, 0.00000000), \
    vec3(0.68898000, 1.18340000, 0.00000000), \
    vec3(-0.07868000, 0.04641000, 1.00000000) \
)
